...
:: -------------------------------------------------------------------------------
set buildPath=\Build\
set appPath=\Fotootof\XtrmAddons.Fotootof\

set SrcSol=%cd%\
call:LogFunc "SrcSol : %SrcSol%"

set SrcProj=%cd%%appPath%
call:LogFunc "SrcProj : %SrcProj%"

set DestProj=%cd%%buildPath%%mode%\
call:LogFunc "DestProj : %DestProj%"

set DestLocal=%DestProj%Local\
call:LogFunc "DestLocal : %DestLocal%"

set DestPack=%DestProj%Packages\
call:LogFunc "DestPack : %DestPack%"

set DestPackExternal=%DestProj%Packages\External\
call:LogFunc "DestPackExternal : %DestPack%"

set DestPackInternal=%DestProj%Packages\Internal\
call:LogFunc "DestPackInternal : %DestPackInternal%"

set DestPlg=%DestProj%Plugins\
