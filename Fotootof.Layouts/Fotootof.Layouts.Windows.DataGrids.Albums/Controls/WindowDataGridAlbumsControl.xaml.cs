using Fotootof.Layouts.DataGrids.Albums.Controls;
using Fotootof.Layouts.Windows.DataGrids.Albums.Models;
using System;
...
namespace Fotootof.Layouts.Windows.DataGrids.Albums.Controls
{
    /// <summary>
    /// Class XtrmAddons Fotootof Layouts Window Albums Data Grid.
    /// </summary>
    public partial class WindowDataGridAlbumsControl : WindowBaseForm
    {
        #region Variable
        ...
        /// </summary>
        public new WindowDataGridAlbumsModel Model { get; private set; }

        /// <summary>
        /// Proper to get selected Albums.
        /// </summary>
        public ObservableCollection<AlbumEntity> SelectedAlbums 
            => (FindName("DataGridAlbumsControlName") as DataGridAlbumsControl).SelectedAlbums;
        ...
        /// </summary>
        public WindowDataGridAlbumsControl() : base()
        {
            InitializeComponent();
        ...
        public void Window_Loaded()
        {
            ...
            Model = new WindowDataGridAlbumsModel(this);
            LoadAlbums();
