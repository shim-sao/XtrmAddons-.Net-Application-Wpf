...
using Fotootof.Layouts.Windows.Settings.Models;

namespace Fotootof.Layouts.Windows.Settings.Controls
{
    /// <summary>
    /// Class XtrmAddons Fotootof Layouts Windows Settings.
    /// </summary>
    public partial class WindowSettingsControl : WindowBaseForm
    {
        #region Variables
