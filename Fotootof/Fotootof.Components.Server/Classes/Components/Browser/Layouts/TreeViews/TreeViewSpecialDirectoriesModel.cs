...
namespace Fotootof.Components.Server.Browser.Layouts
{
    ...
    /// </summary>
    internal class TreeViewSpecialDirectoriesModel : ControlLayoutModel<TreeViewSpecialDirectoriesLayout>
    {
        #region Variables
        ...
        /// </summary>
        public TreeViewSpecialDirectoriesModel() : base()
        {
            InitializeModel();
        }
        ...
        /// Class XtrmAddons Fotootof Components Server Browser Storage System Tree View Model Constructor.
        /// </summary>
        /// <param name="controlView">The <see cref="TreeViewSpecialDirectoriesLayout"/> owner of the model.</param>
        public TreeViewSpecialDirectoriesModel(TreeViewSpecialDirectoriesLayout controlView) : base(controlView)
        {
            InitializeModel();
        }
