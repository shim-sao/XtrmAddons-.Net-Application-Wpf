...
{
    /// <summary>
    /// Class XtrmAddons Fotootof Component Server Page Section Model Shared.
    /// </summary>
    internal class PageSectionModelShared : ComponentModel<PageSectionLayout>
    {
        #region Variables
        ...
        public PageSectionModelShared(PageSectionLayout controlView) : base(controlView) { }
