...
namespace XtrmAddons.Fotootof.Lib.SQLite
{
    /// <summary>
    /// Class XtrmAddons Lib SQLite Translation.
    /// </summary>
    internal static class SQLiteTranslation
    {
        ...
        private static Dictionary<string, ResourceManager> rms 
            ...
            {
                { "Words", new ResourceManager("XtrmAddons.Fotootof.Lib.SQLite.Properties.Resources", System.Reflection.Assembly.GetExecutingAssembly()) },
                { "Logs", new ResourceManager("XtrmAddons.Fotootof.Lib.SQLite.Properties.ResourcesLogs", System.Reflection.Assembly.GetExecutingAssembly()) }
            };
