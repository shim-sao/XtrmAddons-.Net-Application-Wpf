...
namespace XtrmAddons.Fotootof.LayoutsOld.Windows.Settings
{
    ...
    public partial class WindowSettings : WindowBaseForm
    {
        ...
        public new XtrmAddons.Fotootof.LayoutsOld.Windows.Settings.WindowSettingsModel Model
        {
            get => (XtrmAddons.Fotootof.LayoutsOld.Windows.Settings.WindowSettingsModel)model;
