...
using XtrmAddons.Fotootof.LayoutsOld.Windows.About;
using XtrmAddons.Fotootof.LayoutsOld.Windows.Forms.AlbumForm;
using XtrmAddons.Fotootof.LayoutsOld.Windows.Forms.ClientForm;
using XtrmAddons.Fotootof.LayoutsOld.Windows.Forms.UserForm;
...
namespace XtrmAddons.Fotootof.LayoutsOld.Menu
{
    /// <summary>
    ...
    public partial class MenuMain : UserControl
    {
        ...
        {
            // Show open file dialog box 
            WindowSettingsControl dlg = new WindowSettingsControl();
            bool? result = dlg.ShowDialog();
