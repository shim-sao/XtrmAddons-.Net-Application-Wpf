...
namespace XtrmAddons.Fotootof.Libraries.Common.Windows.Slideshow
{
    public class WindowSlideshowModel<WindowSlideshow> : WindowBaseModel<WindowSlideshow>
    {
        ...
        public WindowSlideshowModel(WindowSlideshow pageBase)
            : base(pageBase) { }
        ...
        {
            ((ZoomBorder)OwnerBase.GetPropertyValue("CurrentZoom")).Reset();
        }
