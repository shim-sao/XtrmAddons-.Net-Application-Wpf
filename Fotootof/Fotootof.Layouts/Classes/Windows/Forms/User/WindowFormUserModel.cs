...
namespace Fotootof.Layouts.Windows.Forms.User
{
    /// <summary>
    ...
    public class WindowFormUserModel : WindowLayoutFormModel<WindowFormUserLayout>
    {
        ...
        public WindowFormUserModel(WindowFormUserLayout owner) : base(owner) { }

        /// <summary>
        /// Class XtrmAddons Fotootof Layouts Window User Form Model Constructor.
        /// </summary>
        /// <param name="pBase"></param>
        public WindowFormUserModel(WindowFormUserLayout owner, int UserId) : this(owner)
        {
            LoadUser(UserId); ;
