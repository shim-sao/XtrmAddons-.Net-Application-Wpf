...
namespace Fotootof.Menus
{
    ...
    public class MainMenuHorizontalModel : ModelBase<MainMenuHorizontalLayout>
    {
        ...
        /// 
        /// </summary>
        public bool IsShowLogsFrame
        {
            get
            {
                return Settings.Controls.Default.MainMenuMenuItemDisplayLogsIsChecked;
            }
            set
            {
                if(Settings.Controls.Default.MainMenuMenuItemDisplayLogsIsChecked != value)
                {
                    Settings.Controls.Default.MainMenuMenuItemDisplayLogsIsChecked = value;
                    NotifyPropertyChanged();
                }
            }
        }
