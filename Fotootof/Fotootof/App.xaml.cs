using Fotootof.Settings;
using Fotootof.Startup;
...
namespace Fotootof
{
    ...
    public partial class App : Application
    {
        ...
        {
            Trace.TraceInformation(Local.Properties.Logs.InitializingLog4NetConfigurator);
        ...
        private void App_Reset()
        {
            ...
            {
                Trace.TraceInformation(Local.Properties.Logs.WaitingDeletingOptions);
                System.IO.Directory.Delete(DirectoryHelper.UserAppData, true);
                Trace.TraceInformation(string.Format(CultureInfo.CurrentCulture, Local.Properties.Logs.ItemDeleted, DirectoryHelper.UserAppData));

                Trace.TraceInformation(Local.Properties.Logs.WaitingDeletingUserOptions);
                System.IO.Directory.Delete(DirectoryHelper.UserMyDocuments, true);
                Trace.TraceInformation(string.Format(CultureInfo.CurrentCulture, Local.Properties.Logs.ItemDeleted, DirectoryHelper.UserMyDocuments));
