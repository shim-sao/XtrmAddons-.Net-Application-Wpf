...
namespace Fotootof.Local
{
    /// <summary>
    /// Class XtrmAddons Fotootof Local Translation.
    /// </summary>
    public static class Translation
    {
        ...
        /// </summary>
        private static readonly Dictionary<string, ResourceManager> rms 
            = new Dictionary<string, ResourceManager>()
            {
                { "Words", new ResourceManager($"{Assembly.GetExecutingAssembly()}.Properties.Resources", Assembly.GetExecutingAssembly()) },
                { "Logs", new ResourceManager($"{Assembly.GetExecutingAssembly()}.ResourcesLogs", Assembly.GetExecutingAssembly()) }
            };

        /// <summary>
        /// Variable dictionary of resources dictionary of culture translations.
        /// </summary>
        private static readonly Dictionary<string, ResourceDictionary> rds 
