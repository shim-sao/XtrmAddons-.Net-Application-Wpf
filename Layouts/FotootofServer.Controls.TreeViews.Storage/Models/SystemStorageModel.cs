...
namespace FotootofServer.Controls.TreeViews.Storage
{
    ...
    /// </summary>
    internal class SystemStorageModel : ModelBase<SystemStorageControl>
    {
        #region Variables
        ...
        /// </summary>
        public SystemStorageModel() : base()
        {
            InitializeModel();
        }
        ...
        public SystemStorageModel(SystemStorageControl owner) : base(owner)
        {
            InitializeModel();
        }
