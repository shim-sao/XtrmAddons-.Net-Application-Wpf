...
{
    /// <summary>
    /// Class Fotootof.SQLite.EntityManager Data Base Observable Dependencies.
    /// </summary>
    ...
    public class ObservableDependencyBase<T, O, E> : ObservableCollection<T> where O : class where E : class
    {
        ...
        /// <summary>
        /// Class Fotootof.SQLite.EntityManager Data Base Observable Dependencies Constructor.
        /// </summary>
